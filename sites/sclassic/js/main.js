...
/******/ 	return __webpack_require__(__webpack_require__.s = "./frontend/source/js/index.js");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony import */ var _modules_search__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/search */ "./frontend/source/js/modules/search.js");
/* harmony import */ var _modules_up__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/up */ "./frontend/source/js/modules/up.js");
/* harmony import */ var _modules_menu__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/menu */ "./frontend/source/js/modules/menu.js");
/* harmony import */ var _modules_header__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/header */ "./frontend/source/js/modules/header.js");
/* harmony import */ var _modules_amount_btn__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/amount-btn */ "./frontend/source/js/modules/amount-btn.js");
/* harmony import */ var _modules_sliders__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/sliders */ "./frontend/source/js/modules/sliders.js");
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  var btns = document.querySelectorAll('.js--amount-btn');
  ...
  btns.forEach(function (btn) {
    var minusBtn = btn.querySelector('.js--amount-btn-minus');
    var plusBtn = btn.querySelector('.js--amount-btn-plus');
    var numberContainer = btn.querySelector('.js--amount-btn-number');
    minusBtn.addEventListener('click', function () {
      if (numberContainer.innerHTML > 0) {
        numberContainer.innerHTML = parseInt(numberContainer.innerHTML) - 1;
    ...
    plusBtn.addEventListener('click', function () {
      if (numberContainer.innerHTML < 100) {
        numberContainer.innerHTML = parseInt(numberContainer.innerHTML) + 1;
        /* eslint-disable-line radix */
...
/***/ "./frontend/source/js/modules/header.js":
/*!**********************************************!*\
  !*** ./frontend/source/js/modules/header.js ***!
  \**********************************************/
/*! exports provided: default */
...
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (function () {
  var scrollOldVal = window.pageYOffset;
  ...
  window.addEventListener('scroll', function () {
    if (window.pageYOffset > 96) {
      if (window.pageYOffset < scrollOldVal) {
    ...
    scrollOldVal = window.pageYOffset;
  });
});

/***/ }),

/***/ "./frontend/source/js/modules/menu.js":
/*!********************************************!*\
  !*** ./frontend/source/js/modules/menu.js ***!
  \********************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  var openBtn = body.querySelector('.js--burger-open');
  var closeBtn = body.querySelector('.js--burger-close');
  var menu = body.querySelector('.js--menu');

  if (!openBtn || !menu || !closeBtn) {
    return;
  }

  var cover = menu.querySelector('.js--menu-cover');
  var firstLevelItems = menu.querySelectorAll('.js--first-level-item');
  var backBtn = menu.querySelector('.js--back-menu');

  if (!cover || !firstLevelItems || !backBtn) {
    return;
  }

  function closeMenu() {
    menu.classList.remove('open', 'second-level-menu', 'third-level-menu');
  ...
  openBtn.addEventListener('click', function () {
    ...
    firstLevelItems.forEach(function (firstLevelItem) {
      firstLevelItem.onclick = function openSecondLevel(e) {
        /* eslint-disable-line no-param-reassign */

        /* eslint-disable-line max-len */
        var secondLevelItems = firstLevelItem.querySelectorAll('.js--second-level-item');
        var thirdLevelLists = firstLevelItem.querySelectorAll('.js--third-level-list');

        if (e.target.closest('.js--to-second-level')) {
          if (!menu.classList.contains('second-level-menu')) {
            menu.classList.add('second-level-menu');
          } else if (menu.classList.contains('second-level-menu')) {
            menu.classList.remove('third-level-menu');
            menu.classList.remove('second-level-menu');
          }
        } else {
          e.preventDefault();
        }

        secondLevelItems.forEach(function (secondLevelItem) {
          secondLevelItem.addEventListener('click', function () {
            var thirdActiveList = thirdLevelLists[Array.from(secondLevelItems).indexOf(secondLevelItem)];
            /* eslint-disable-line max-len */

            secondLevelItems.forEach(function (item) {
              item.classList.remove('active');
              thirdLevelLists[Array.from(secondLevelItems).indexOf(item)].classList.remove('active');
            });
            menu.classList.add('third-level-menu');
            secondLevelItem.classList.add('active');
            thirdActiveList.classList.add('active');
            thirdActiveList.querySelector('.js--back-to-second-level').addEventListener('click', function () {
              menu.classList.remove('third-level-menu');
              secondLevelItem.classList.remove('active');
              thirdActiveList.classList.remove('active');
            });
          });
        });
        backBtn.addEventListener('click', function () {
          menu.classList.remove('second-level-menu', 'third-level-menu');
          secondLevelItems.forEach(function (secondLevelItem) {
            secondLevelItem.classList.remove('active');
            thirdLevelLists[Array.from(secondLevelItems).indexOf(secondLevelItem)].classList.remove('active');
          });
        });
      };
    });
...
/***/ "./frontend/source/js/modules/search.js":
/*!**********************************************!*\
  !*** ./frontend/source/js/modules/search.js ***!
  \**********************************************/
/*! exports provided: default */
...
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (function () {
  var containers = document.querySelectorAll('.js--search-container');
  ...
  containers.forEach(function (container) {
    var openBtn = container.querySelector('.js--search-open');
    var closeBtn = container.querySelector('.js--search-close');
    var form = container.querySelector('.js--form');
...
/***/ "./frontend/source/js/modules/sliders.js":
/*!***********************************************!*\
  !*** ./frontend/source/js/modules/sliders.js ***!
  \***********************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  swiper__WEBPACK_IMPORTED_MODULE_0__["default"].use([swiper__WEBPACK_IMPORTED_MODULE_0__["Navigation"], swiper__WEBPACK_IMPORTED_MODULE_0__["Scrollbar"], swiper__WEBPACK_IMPORTED_MODULE_0__["EffectFade"]]);
  var bigSliders = document.querySelectorAll('.js--big-slider');
  bigSliders.forEach(function (slider) {
...
/***/ "./frontend/source/js/modules/up.js":
/*!******************************************!*\
  !*** ./frontend/source/js/modules/up.js ***!
  \******************************************/
/*! exports provided: default */
...
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (function () {
  var upBtns = document.querySelectorAll('.js--up');
